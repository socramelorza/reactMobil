    ...
    return (
        ...
        <MapView initialRegion={currentRegion} style={styles.map}>
            <Marker coordinate={{ latitude: -27.2111164, longitude: -49.6374491 }}>
                <Image style={styles.avatar} source={{ uri: 'https://avatars3.githubusercontent.com/u/18582369?s=460&v=4'}}/>
                
                <Callout onPress={() => {
                        navigation.navigate('Profile', { github_username: 'diego3g'});
                    }}>
                    <View style={style.callout}>
                        <Text style={style.devName}>Diego Fernandes</Text>
                        <Text style={style.devBio}>CTO na @Rocketseat. faz moagens com tecnologias</Text>
